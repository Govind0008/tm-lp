      ...
      <section className="self-center w-full max-w-[1200px] mt-14 px-4">
        <div className="gap-5 flex max-md:flex-col max-md:items-stretch">
          ...
          >
            ...
            <h1 className="text-left text-[rgba(32,33,36,1)] text-5xl font-[275] leading-[60px] tracking-[-1.5px] max-md:text-[40px] max-md:leading-[56px]">
              <span className="font-light">
                The First Comprehensive <br /> Mineral Title Review <br />Platform for <br />{" "}
              </span>
              ...
              <p className="text-[#202124] text-left text-lg leading-[29px] self-stretch mt-[47px]">
              ...
              <p className="text-[#202124] text-sm text-left leading-none mt-[50px]">
